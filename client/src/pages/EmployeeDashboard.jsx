          ...
          <div className="bg-white rounded-3xl p-8 max-w-lg w-full shadow-2xl relative">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-5">
               <div>
                  ...
                  <input type="number" step="0.01" name="amount" value={formData.amount} onChange={handleTextChange} placeholder="Leave blank for AI auto-fill" className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#003345]/20 focus:border-[#003345] outline-none" />
               </div>
               <div>
               ...
               <div>
                  ...
                  <input type="date" name="date" value={formData.date} onChange={handleTextChange} className="w-full p-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#003345]/20 focus:border-[#003345] outline-none" />
                  <p className="text-xs text-[#003345]/60 mt-1 font-medium">Leave blank to extract from receipt</p>
               </div>
               <div>
